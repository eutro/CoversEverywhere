...
public class TileEntityTransformer extends ClassVisitor implements Opcodes {
    ...
    public static <T> T getCapabilityWrapped(@Nullable T toWrap, Object self, Capability<T> capability,
    ...
    @SuppressWarnings("unused")
    public static boolean hasCapabilityWrapped(boolean toWrap, Object self, Capability<?> capability,
                                               @Nullable EnumFacing facing,
                                               Class<?> calling) {
    ...
    @Nullable
    private static <T> T doWrap(@Nullable T toWrap, TileEntity self, Capability<T> capability,
                                @Nullable EnumFacing facing) {
    ...
    private static boolean doWrapHas(boolean toWrap, TileEntity self, Capability<?> capability,
                                     @Nullable EnumFacing facing) {
        if (facing == null) return toWrap;
        ICoverHolder holder = self.getCapability(getApi().getHolderCapability(), facing);
        if (holder == null) return toWrap;
